...
export default function Hero() {
  ...
  return (
    <section id="home" className="pt-[150px] nav:pt-[180px] pb-[60px] nav:pb-[100px] relative">
      <div className="max-w-[1140px] mx-auto px-7 grid grid-cols-1 nav:grid-cols-[1.05fr_0.95fr] gap-[60px] items-center">
        <div>
          ...
          <h1 className="font-display font-bold leading-[1.06] tracking-[-0.02em] text-[clamp(2.6rem,5.5vw,4.2rem)]">
            Noman Nawaz
            <br />
            builds <span className="text-gradient-accent">full‑stack products</span> on the MERN stack.
          </h1>
          <p className="mt-[22px] text-[1.1rem] text-ink-muted max-w-[480px]">
            I design and ship web applications end to end — from MongoDB schemas to React interfaces — with a
            focus on clean architecture, fast APIs, and interfaces people actually enjoy using.
          </p>
          ...
          <div className="flex gap-7 mt-12 flex-wrap">
            <div className="border-l-2 border-violet pl-[14px]">
              ...
              <div className="text-[0.8rem] text-ink-muted mt-[2px]">Shipped projects</div>
            </div>
            <div className="border-l-2 border-violet pl-[14px]">
              <div className="font-display font-bold text-[1.5rem]">1</div>
              <div className="text-[0.8rem] text-ink-muted mt-[2px]">Internship completed</div>
            </div>
            <div className="border-l-2 border-violet pl-[14px]">
              <div className="font-display font-bold text-[1.5rem]">7</div>
              <div className="text-[0.8rem] text-ink-muted mt-[2px]">Core technologies</div>
            </div>
          </div>
        </div>
        ...
        <FadeUp className="bg-panel border border-border rounded-2xl shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-3 bg-panel-2 border-b border-border">
            ...
            <span className="ml-[10px] font-mono text-[0.78rem] text-ink-muted">developer.json</span>
          </div>
